...
* [4. Quick Start Guide](#4-quick-start-guide)
    * [Creating a WaveManager via Editor Menu](#creating-a-wavemanager-via-editor-menu)
* [5. Core Concepts](#5-core-concepts)
    * [WaveManager](#wavemanager)
    * [Wave](#wave)
    * [BurstSpawnEntry](#burstspawnentry)
    * [EnemyTypeInBurst](#enemytypeinburst)
* [6. Inspector Reference](#6-inspector-reference)
    ...
    * [Debugging](#debugging)
* [7. API Reference & Integration](#7-api-reference--integration)
    * [Subscribing to Events](#subscribing-to-events)
    * [Returning Enemies to Pool](#returning-enemies-to-pool)
    * [Manually Starting Waves](#manually-starting-waves)
    * [Retrieving Wave Information](#retrieving-wave-information)
